...
and [phase-1.md](../tasks/phase-1.md). This document captures the **things that can bite us** during
...
> A4 (displaced XOR native) remains a **Phase-3 correctness requirement**. See [phase-2.md](../tasks/phase-2.md)
> and [bug-fix-log.md](../bugs/bug-fix-log.md).
